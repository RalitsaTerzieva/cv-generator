...
You can use this custom Django application to practice simple operations for creating your first Django based CV builder. You can add more icons, styles and logic if you want to learn more.
